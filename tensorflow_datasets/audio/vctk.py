  ...
  def _info(self):
    ...
    return tfds.core.DatasetInfo(
        ...
        features=tfds.features.FeaturesDict({
            ...
            "speech": tfds.features.Audio(sample_rate=48000, dtype=np.int16),
            "speaker": tfds.features.ClassLabel(names=speaker_list),
            "gender": tfds.features.ClassLabel(names=["F", "M"]),
            "accent": tfds.features.ClassLabel(
                names=[
                    "American",
                    "Australian",
                    "British",
