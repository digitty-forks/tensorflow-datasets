...
DATASET_MAP = {  # pylint:disable=g-complex-comprehension
    ds.name: ds
    for ds in [
        ...
        SubDataset(
            name="EMEA",
            description=(
                "A parallel corpus made out of PDF documents from the European"
                " Medicines Agency."
            ),
        ...
        SubDataset(
            name="JRC-Acquis",
            description=(
                "A collection of legislative text of the European Union and"
                " currently comprises selected texts written between the 1950s"
                " and now."
            ),
        ...
        SubDataset(
            name="Tanzil",
            description=(
                "A collection of Quran translations compiled by the Tanzil"
                " project."
            ),
        ...
        SubDataset(
            name="GNOME",
            description=(
                "A parallel corpus of GNOME localization files. Source:"
        ...
        SubDataset(
            name="PHP",
            description=(
                "A parallel corpus originally extracted from"
        ...
        SubDataset(
            name="Ubuntu",
            description=(
                "A parallel corpus of Ubuntu localization files. Source:"
        ...
        SubDataset(
            name="OpenSubtitles",
            description=(
                "A new collection of translated movie subtitles from"
...
class OpusConfig(tfds.core.BuilderConfig):
  ...
  def __init__(self, *, language_pair, subsets, **kwargs):
    ...
    name = kwargs.get(
        ...
        "%s-%s for %s"
        % (
            sorted_language_pair[0],
            sorted_language_pair[1],
            ", ".join(subsets),
        ),
    )
